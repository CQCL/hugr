...
#[case(PolyFuncType::new([TypeParam::TupleType { params: [TypeBound::Any.into(), TypeParam::bounded_nat_type(2.try_into().unwrap())].into() }], Signature::new_endo(type_row![])))]
...
#[case(PolyFuncTypeRV::new([TypeParam::TupleType { params: [TypeBound::Any.into(), TypeParam::bounded_nat_type(2.try_into().unwrap())].into() }], FuncValueType::new_endo(type_row![])))]
