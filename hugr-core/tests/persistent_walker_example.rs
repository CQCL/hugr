...
use hugr::{IncomingPort, OutgoingPort, Port, ops::OpType, types::EdgeKind};
use itertools::{Either, Itertools};

use hugr_core::{
    Hugr, HugrView, PortIndex,
    builder::{DFGBuilder, Dataflow, DataflowHugr, endo_sig},
    extension::prelude::qb_t,
    hugr::persistent::{Commit, CommitStateSpace, PinnedWire, Walker},
};
...
fn create_commit(wire: PinnedWire, walker: &Walker) -> Option<Commit> {
