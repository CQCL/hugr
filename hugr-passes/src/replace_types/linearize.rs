...
use super::{NodeTemplate, ParametricType, handlers::linearize_array};
...
mod test {
    ...
    use hugr_core::std_extensions::collections::array::{
        ArrayOpDef, ArrayRepeat, ArrayScan, ArrayScanDef, array_type, array_type_def,
    };
    ...
    fn array(#[values(2, 3, 4)] num_outports: usize) {
        ...
        assert_eq!(
            copy_sig.output,
            TypeRow::from(
                [array_type(5, lin_t.clone()), INT_TYPES[6].clone()]
                    .into_iter()
                    .chain(vec![
