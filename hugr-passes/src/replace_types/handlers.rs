...
/// Handler for generating discards, for use with [ReplaceTypes::linearize_parametric] of
...
/// Handler for generating copies, for use with [ReplaceTypes::linearize_parametric] of
/// [array_type_def](hugr_core::std_extensions::collections::array::array_type_def)
