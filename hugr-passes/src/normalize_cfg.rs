...
use hugr_core::ops::{CFG, DFG, DataflowParent, ExitBlock, OpTag, OpType};
use hugr_core::{Direction, HugrView, OutgoingPort, PortIndex};

use crate::ComposablePass;
#[expect(deprecated)] // refactor/inline merge_basic_blocks, or just hide it
use crate::merge_bbs::merge_basic_blocks;
...
pub(crate) fn wire_unpack_first<H: HugrMut>(
    h: &mut H,
...
mod test {
    ...
    #[expect(deprecated)]
    // when merge_basic_blocks removed/hidden, consider testing normalize_cfgs directly
