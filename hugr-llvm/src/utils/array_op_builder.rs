use hugr_core::std_extensions::collections::array::{ArrayKind, GenericArrayOpDef};
...
pub mod test {
    ...
    use hugr_core::std_extensions::collections::value_array::{self, value_array_type};
    use hugr_core::{
    ...
    pub fn all_value_array_ops<B: Dataflow>(
